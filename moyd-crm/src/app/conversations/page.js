...
import { MessageSquare, Search, Ban, CheckCircle } from 'lucide-react'
  ...
  async function loadConversations() {
    try {
      const { data, error } = await supabase
        ...
        .select(`
          *,
          member:member_id(id, name, phone, phone_e164, county, opt_out, intro_sent_at),
